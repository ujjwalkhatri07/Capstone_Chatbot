...
import { Row, Col, Card, Typography, Space, Divider, Modal, Button } from "antd";
...
export default function Chat() {
  ...
  const API_URL = "http://localhost:8000/question-answering-with-context";
  ...
  return (
    <>
      ...
      <Row gutter={[20, 20]}>
        <Typography.Text strong>Chatbot 🤖 (v 0.1)</Typography.Text>
        <Space size={"large"} />
        <Card title={<SearchForm onFinish={search} />} bordered={true} style={{ width: "100%" }}>
          {
